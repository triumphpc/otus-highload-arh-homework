// Package counters Code generated by swaggo/swag. DO NOT EDIT
package counters
    ...
    "paths": {
        "/api/v2/dialog/unread-count": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Объект с количеством непрочитанных сообщений",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessCountResponse"
                        },
                        "headers": {
                            "x-request-id": {
                                "type": "string",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.DialogMessageV2"
                            }
                        },
                        "headers": {
                            "x-request-id": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SuccessResponseV2"
                        },
                        "headers": {
                            "x-request-id": {
                                "type": "string",
